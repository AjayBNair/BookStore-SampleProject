...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 968af8a1-02f4-4ded-8969-96301e5d05f3
```

> `968af8a1-02f4-4ded-8969-96301e5d05f3` is the password of the certificate, you can change it to any password you want.
